...
> 更新:2026-08-27。CLI 为 `0.1.0-rc.12`(available Release)。三端壳统一 `0.1.0 (1)`。
...
|---|---|---|---|---|---|---|---|
| Desktop CLI | `0.1.0-rc.12` | 见 `docs/release/v0.1.0-rc.12-assets.json` | 不适用(npm tgz) | Node/Python CI + 分发核验 + 六项 smoke | 实体门四项真机证据(Mac/Windows 各 exec+global,`e2e/evidence/2026-08-26-rc12-physical/`;Linux 由 CI 六项 fixed-URL smoke 覆盖,非真机) | **available** GitHub Release(rc.12);不是移动包 | 四场真人验收门(v0.1.0 正式版前) |
