...
发布说明文件(`v0.1.0-rc.*.md`)的保留规则(2026-08-27 月度审计成文,此前散在 `c35d1ba`/`8874105` 两条 commit message):**被证据账本 cross-link 引用的版本说明留存**(rc.2/rc.3/rc.4),**其余随 bump 改名**——因此仓内只有 rc.2/rc.3/rc.4 + 当前版 rc.13 共四份;rc.5–rc.11 无独立说明文件属预期而非缺失。
