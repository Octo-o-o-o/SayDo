...
1. **启动状态机未闭合：bind 失败者可先写 durable 状态，`ready` 也可能早于停机处理器。**
   ...
   - 位置：[index.ts:2641](~/WorkSpace/SayDo/packages/daemon/src/index.ts:2641)、[index.ts:2793](~/WorkSpace/SayDo/packages/daemon/src/index.ts:2793)、[index.ts:3090](~/WorkSpace/SayDo/packages/daemon/src/index.ts:3090)、[index.ts:3223](~/WorkSpace/SayDo/packages/daemon/src/index.ts:3223)
...
2. **pipeline 的同 HOME 校验只影响灯色，不是接入门。**
   ...
   - 位置：[hub.ts:318](~/WorkSpace/SayDo/packages/daemon/src/voice/hub.ts:318)、[hub.ts:340](~/WorkSpace/SayDo/packages/daemon/src/voice/hub.ts:340)、[hub.ts:382](~/WorkSpace/SayDo/packages/daemon/src/voice/hub.ts:382)、[hub.ts:421](~/WorkSpace/SayDo/packages/daemon/src/voice/hub.ts:421)
...
3. **`agent.pid` 与 `agent-owner.json` 的 fail-open 更新可启动同 run 的第二个 agent。**
   ...
   - 位置：[executor.ts:1841](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1841)、[restartPolicy.ts:55](~/WorkSpace/SayDo/packages/daemon/src/tier1/restartPolicy.ts:55)、[restartPolicy.ts:109](~/WorkSpace/SayDo/packages/daemon/src/tier1/restartPolicy.ts:109)
...
4. **`--resume` 没有验证实际恢复到原 native session，却过早清 marker。**
   ...
   - 位置：[executor.ts:1780](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1780)、[executor.ts:1800](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1800)、[executor.ts:1017](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1017)、[tasks.ts:211](~/WorkSpace/SayDo/packages/daemon/src/storage/dao/tasks.ts:211)
...
5. **desktop、prepare 与真实 recovery 使用不同的 recoverability predicate。**
   ...
   - 位置：[desktop.ts:14](~/WorkSpace/SayDo/packages/daemon/src/api/desktop.ts:14)、[restartPolicy.ts:39](~/WorkSpace/SayDo/packages/daemon/src/tier1/restartPolicy.ts:39)、[executor.ts:1914](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1914)、[executor.ts:1651](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1651)
...
6. **强制退出只按时间和 daemon PID收口，不能保证 agent 进程树已消失。**
   ...
   - 位置：[supervisor.ts:27](~/WorkSpace/SayDo/packages/cli/src/supervisor.ts:27)、[supervisor.ts:151](~/WorkSpace/SayDo/packages/cli/src/supervisor.ts:151)、[index.ts:3167](~/WorkSpace/SayDo/packages/daemon/src/index.ts:3167)、[recoveryOnlyServer.ts:215](~/WorkSpace/SayDo/packages/daemon/src/api/recoveryOnlyServer.ts:215)
...
1. **构建 identity 可碰撞或错标 dirty 输入。**
   ...
   - 位置：[build.mjs:14](~/WorkSpace/SayDo/packages/cli/scripts/build.mjs:14)、[build.mjs:35](~/WorkSpace/SayDo/packages/cli/scripts/build.mjs:35)、[build.mjs:37](~/WorkSpace/SayDo/packages/cli/scripts/build.mjs:37)
...
2. **supervisor 对 setup restart 没有次数限制或熔断。**
   ...
   - 位置：[supervisor.ts:96](~/WorkSpace/SayDo/packages/cli/src/supervisor.ts:96)、[supervisor.ts:180](~/WorkSpace/SayDo/packages/cli/src/supervisor.ts:180)
...
3. **recovery-only 在 pre-ready stop 后仍可能启动 listener。**
   ...
   - 位置：[recoveryOnlyServer.ts:193](~/WorkSpace/SayDo/packages/daemon/src/api/recoveryOnlyServer.ts:193)、[recoveryOnlyServer.ts:624](~/WorkSpace/SayDo/packages/daemon/src/api/recoveryOnlyServer.ts:624)、[recoveryOnlyServer.ts:653](~/WorkSpace/SayDo/packages/daemon/src/api/recoveryOnlyServer.ts:653)
...
4. **已收到 agent terminal result 时的 shutdown 仍会写 restart marker并重复执行。**
   ...
   - 位置：[executor.ts:1025](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1025)、[executor.ts:1119](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1119)、[executor.ts:1914](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1914)
...
5. **恢复前置失败进入终态时不清 restart marker。**
   ...
   - 位置：[executor.ts:1463](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1463)、[executor.ts:1750](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1750)、[executor.ts:1816](~/WorkSpace/SayDo/packages/daemon/src/tier1/executor.ts:1816)
...
6. **正常与 recovery-only 的 shutdown scope 都漏掉在途 setup request；LiveDialog 自有 timer 也未停止。**
   ...
   - 位置：[index.ts:982](~/WorkSpace/SayDo/packages/daemon/src/index.ts:982)、[index.ts:3126](~/WorkSpace/SayDo/packages/daemon/src/index.ts:3126)、[recoveryOnlyServer.ts:549](~/WorkSpace/SayDo/packages/daemon/src/api/recoveryOnlyServer.ts:549)、[dialog.ts:594](~/WorkSpace/SayDo/packages/daemon/src/live/dialog.ts:594)、[dialog.ts:1299](~/WorkSpace/SayDo/packages/daemon/src/live/dialog.ts:1299)
...
7. **distribution 门仍会对多条合同路径产生假阳性，失败清理也不闭合。**
   ...
   - 位置：[verify-distribution.mjs:72](~/WorkSpace/SayDo/packages/cli/scripts/verify-distribution.mjs:72)、[verify-distribution.mjs:360](~/WorkSpace/SayDo/packages/cli/scripts/verify-distribution.mjs:360)、[verify-distribution.mjs:446](~/WorkSpace/SayDo/packages/cli/scripts/verify-distribution.mjs:446)、[verify-distribution.mjs:491](~/WorkSpace/SayDo/packages/cli/scripts/verify-distribution.mjs:491)
...
1. **重复 `--home`/`--port` 被接受且静默取第一次。**
   ...
   - 位置：[options.ts:18](~/WorkSpace/SayDo/packages/cli/src/options.ts:18)、[options.ts:31](~/WorkSpace/SayDo/packages/cli/src/options.ts:31)
   - 触发：`saydo up --port 47100 --port 48100`，扫描认为合法，`indexOf` 只读取 47100。
   - 最小修法：单次顺序解析并拒绝重复 flag。

2. **浏览器 opener 启动失败会产生未处理的 child `error`。**

   - 位置：[open.ts:7](~/WorkSpace/SayDo/packages/cli/src/open.ts:7)、[supervisor.ts:135](~/WorkSpace/SayDo/packages/cli/src/supervisor.ts:135)
